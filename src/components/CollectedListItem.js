    ...
    return (
        <div className='flex flex-wrap py-1 px-4 border border-primary justify-between items-center'>
            <div className='flex flex-wrap space-x-4 items-center'>
                <div id='finish' className='font-bold w-10 text-center outline outline-1 rounded'>{finishSign}</div>
                <div id='amount' className='w-10 text-center outline outline-1 rounded'>{amount}x</div>
