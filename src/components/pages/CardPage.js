                ...
                ? <>
                    ...
                    <div id='external links' className='w-96 p-2 flex flex-col space-y-1'>
                        ...
                        {card.external_links.cardmarket &&
                            <ExternalLink href={card.external_links.cardmarket} externalParty="Cardmarket" imageLocation={"https://static.cardmarket.com/img/526dbb9ae52c5e62404fe903e9769807/static/misc/favicon-96x96.png"} />}
                        {card.external_links.tcgplayer &&
                            <ExternalLink href={card.external_links.tcgplayer} externalParty="TCGPlayer" imageLocation={"https://www.tcgplayer.com/favicon.ico"} />}
                        {card.external_links.gatherer &&
                            <ExternalLink href={card.external_links.gatherer} externalParty="Gatherer" imageLocation={"https://gatherer.wizards.com/Images/favicon.ico"} />}
                    </div>
                </>
                :
                <Loading />
